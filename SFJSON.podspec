#
#  Be sure to run `pod spec lint SFJSON.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Simon Germain" => "sgermain06@gmail.com" }
  # Or just: s.author    = "Simon Germain"
  # s.authors            = { "Simon Germain" => "simon.germain@bluesombrero.com" }
  # s.social_media_url   = "http://twitter.com/Simon Germain"
